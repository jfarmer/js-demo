...
function playNote(note, waveform = 'square') {
  if (context === undefined) {
    context = new AudioContext();
  }

  if (!hasKey(noteFrequencies, note)) {
    throw new Error(`Unknown note: '${note}'`);
  }

  playFreqWithWaveform(noteFrequencies[note], waveform);
}

function playFreqWithWaveform(frequency, waveform) {
